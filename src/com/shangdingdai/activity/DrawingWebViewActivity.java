...
public class DrawingWebViewActivity extends BaseActivity{
	...
	public static final String PATH=Constants.SERVICE_ADDRESS
			+ "goto_Yibao/gotoTixian";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_web_drawing);
		userid = SharePreferenceUtil.getInstance(getApplicationContext())
				.getUseId();
		money=getIntent().getStringExtra("money");
		
		withdrawtype=getIntent().getStringExtra("type");
		initViews();
		initEvents();
	}
