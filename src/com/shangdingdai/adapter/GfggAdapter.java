...
public class GfggAdapter extends BaseListAdapter<GfggBean> {
	...
	public View getContentView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.layout_item_mymsg_gfgg,
					parent, false);
			holder.tv_title = (TextView) convertView
					.findViewById(R.id.tv_title);
			holder.tv_jianjie = (TextView) convertView
					.findViewById(R.id.tv_jianjie);
			holder.tv_time = (TextView) convertView.findViewById(R.id.tv_time);
			convertView.setTag(holder);//为convertView设置TAG标志
		} else {
	...
	/**
	 * 
	 * @author Mersens ViewHolder临时的储存器，利用ListView的缓存机制，提高性能
	 */
